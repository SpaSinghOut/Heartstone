...
final public class Human extends Controller{
	...
	/**
	 * <ul><b>tick</b><p><code>&#8195;final public void tick()</code><p>Performs one update on human input and interface related elements.
	 */
	...
	private void listenForInput() throws SLEImproperInputException{
		for(Camera camera: cameras)edgePan(camera);
