...
public class Console extends StructureObject{;
	...
	public void takeCommand(String inputText) {
		...
		} catch (structure.Console.Parser.IdentifierException 
				| structure.Console.Executer.CommandExecutionException e) {
	...
	private class Executer{
		class CommandExecutionException extends Throwable{
			String type;
		...
		Console owner;
		Executer(Console owner){
			this.owner = owner;
		}
		private void execute(String[] readReadyCommand) throws CommandExecutionException{
